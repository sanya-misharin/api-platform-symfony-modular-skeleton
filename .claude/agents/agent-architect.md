...
Builds a technical plan from a finished spec (Spec Summary), defines structure and implementation boundaries for Coder within **API Platform + Symfony Modular Skeleton** (Symfony 8.1 / API Platform 4.3 / Doctrine ORM 3, **PHP 8.4**).
