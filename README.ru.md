...
🚀 Готовый к продакшену стартовый шаблон для создания модульных REST API бэкендов на **Symfony 7.3** и **API Platform 4.1**.
...
- **API Platform 4.1** — генерация REST API
- **Doctrine ORM 3.5** — абстракция базы данных
